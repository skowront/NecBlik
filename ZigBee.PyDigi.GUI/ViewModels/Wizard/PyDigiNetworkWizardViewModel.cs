...
namespace ZigBee.PyDigi.GUI.ViewModels.Wizard
{
    public class PyDigiNetworkWizardViewModel:BaseViewModel
    {
        ...
        private string networkName = ZigBee.PyDigi.Resources.Resources.DefaultPyDigiNetworkName;
        ...
        public PyDigiNetworkWizardViewModel()
        {
            var portInfoList = SerialPortHelper.GetSerialPorts();
            if (portInfoList.Count > 0)
                this.SerialPortName = portInfoList.Where((o) => o.description.Contains(ZigBee.PyDigi.Resources.Resources.AutoDetectionFilterUSBSerialPort)).First().name;
            else

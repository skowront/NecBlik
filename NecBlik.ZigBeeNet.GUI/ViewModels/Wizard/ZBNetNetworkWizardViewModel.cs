...
namespace NecBlik.ZigBeeNet.GUI.ViewModels.Wizard
{
    public class ZBNetNetworkWizardViewModel : BaseViewModel
    {
        ...
        private string networkName = "ZBNet Network";
        ...
        public ZBNetNetworkWizardViewModel()
        {
            this.BuildCommands();
        }

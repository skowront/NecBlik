...
namespace NecBlik.Common.WpfExtensions.Interfaces
{
    ...
    public interface IResponseProvider<R,Q>where Q:class
    {
        /// <summary>
        ...
        public R ProvideResponse(Q context=null);
    }
    ...
    /// <typeparam name="R">Response type</typeparam>
    /// <typeparam name="Q">Question context type</typeparam>
    public interface ISimpleTypeResponseProvider<R, Q>
    {
        /// <summary>
        /// Returns a response based on given context.
        /// </summary>
        /// <param name="context">Context of the question</param>
        /// <returns>Response of R type</returns>
        public R ProvideResponse(Q context);
    }
    ...
    /// <typeparam name="R">Response type</typeparam>
    /// <typeparam name="Q">Question context type</typeparam>
    public interface IInterruptibleResponseProvider<R,Q> where Q:class
    {
        /// <summary>
        /// Returns a response based on given context.
        /// </summary>
